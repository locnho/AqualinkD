...
Branch pda-ps6-main: This is the main stable branch for 2.x code base.

Branch pda-ps6-dev: This is the development branch for 2.x code base

Branch pda-ps6-dev-v3: This is the development branch for 3.0.0 code base

Branch pda-ps6-dev-v3.0.3: This is the development branch for 3.0.3 code base
...
pda_sleep_mode=YES
#
# For reliability, always go back to MAIN menu
pda_force_home_onprogram=YES
...
button_09_label=Spa Heat
button_10_label=Solar Heat
...
```
 ...
 #
 # This is to support Acid Tank Level/pH Alarm tiles in Web UI of AquaLinkD
 listener 9001
 protocol websockets
 password_file /etc/mosquitto/password_file
...
The hardware that I used is "RPI 5".
